...
class Face_Detector {
 ...
 #El constructor de clase carga el archivo .dat y lo asigna a una variable
 ...
 #Dado un archivo imagen 
  public function face_detect($file) {
    if (!is_file($file)) {
      throw new Exception("No se puede carga el archivo $file");
    }
 	#crea una nueva imagen temporal
